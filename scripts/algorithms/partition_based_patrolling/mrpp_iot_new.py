...
class MRPP_IOT:
    ...
    def callback_ready(self, req):
        algo_name = req.algo
        if algo_name == 'mrpp_iot' and self.ready:
    ...
    def initialize_base_stations(self):
        self.base_staion_good_range = self.Iot_device_range  # Range in meter where there is no packet loss
